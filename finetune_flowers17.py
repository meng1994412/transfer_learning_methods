...
from pipeline.preprocessing import AspectAwarePreprocessor
from pipeline.datasets import SimpleDatasetLoader
from pipeline.nn.conv import FCHeadNet
...
# the class names from the image paths
...
# load the dataset from disk then scale the raw pixel intensties to the range [0, 1]
...
# they will not be update during the training process
for layer in baseModel.layers:
    layer.trainable = False

# compile our model (this needs to be done after our setting
# our layers to be ing non-trainable)
...
# of CONV layers along with or set of FC layers
